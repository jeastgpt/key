--- START OF FILE Paste February 17, 2026 - 10:05PM ---

--[[
    SimpleSpy v2.2 SOURCE (MODIFIED)

    Modifications:
    1. Fixed clickable area of logs (expanded to full cell size)
    2. Reduced Max Packet limit to 50
...
-- [MODIFIED 1] Fix the slightly off clickable area by making the button fill the template
...
--- [MODIFIED 2] the maximum amount of remotes allowed in logs
_G.SIMPLESPYCONFIG_MaxRemotes = 50
...
-- [MODIFIED 3] Pause Button implementation
newButton("Pause/Resume", function()
	return string.format("[%s] Toggles the capture of remote logs without closing SimpleSpy.", isPaused and "PAUSED" or "RESUMED")
end, function(button)
	isPaused = not isPaused
	TextLabel.Text = string.format("[%s] Logging is now %s.", isPaused and "PAUSED" or "RESUMED", isPaused and "paused" or "active")
	-- Optional: Update button text visually if desired (since the text only updates on hover/refresh)
	button.Text.Text = "Pause/Resume" 
end)